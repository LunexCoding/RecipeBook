...
################################################################################
## Form generated from reading UI file 'interfaceEviMLn.ui'
##
...
"}")
        ...
        self.filesBtn.setIcon(icon3)
        self.filesBtn.setIconSize(QSize(24, 24))
        ...
        self.closeNotifacationBtn.setIcon(icon14)
...
#if QT_CONFIG(tooltip)
        self.recipesBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Language mode", None))
#endif // QT_CONFIG(tooltip)
        self.recipesBtn.setText(QCoreApplication.translate("MainWindow", u"Language mode", None))
#if QT_CONFIG(tooltip)
        self.filesBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Files", None))
#endif // QT_CONFIG(tooltip)
        self.filesBtn.setText(QCoreApplication.translate("MainWindow", u"Files", None))
#if QT_CONFIG(tooltip)
